...
# User input section with GREEN highlighted variable labels
echo -e "${CYAN}Please enter the following configuration details:${NC}"
echo ""

read -p "$(echo -e "${GREEN}ENTER VPC_NAME: ${NC}")" VPC_NAME
echo ""

read -p "$(echo -e "${GREEN}ENTER SUBNET_A: ${NC}")" SUBNET_A
echo ""

read -p "$(echo -e "${GREEN}ENTER SUBNET_B: ${NC}")" SUBNET_B
echo ""

read -p "$(echo -e "${GREEN}ENTER FIREWALL_1: ${NC}")" FIREWALL_1
echo ""

read -p "$(echo -e "${GREEN}ENTER FIREWALL_2: ${NC}")" FIREWALL_2
echo ""

read -p "$(echo -e "${GREEN}ENTER FIREWALL_3: ${NC}")" FIREWALL_3
echo ""

read -p "$(echo -e "${GREEN}ENTER ZONE_1 (e.g., us-central1-a): ${NC}")" ZONE_1
echo ""

read -p "$(echo -e "${GREEN}ENTER ZONE_2 (e.g., us-east1-b): ${NC}")" ZONE_2
echo ""
...
echo -e "${GREEN}╠════════════════════════════════════════════╣${NC}"
echo -e "${GREEN}║ ${CYAN}VPC Name:${NC} $VPC_NAME"
echo -e "${GREEN}║ ${CYAN}Subnet A:${NC} $SUBNET_A (Region: $REGION_1)"
echo -e "${GREEN}║ ${CYAN}Subnet B:${NC} $SUBNET_B (Region: $REGION_2)"
echo -e "${GREEN}║ ${CYAN}Firewall Rules:${NC} $FIREWALL_1, $FIREWALL_2, $FIREWALL_3"
echo -e "${GREEN}║ ${CYAN}Zones:${NC} $ZONE_1, $ZONE_2"
echo -e "${GREEN}║ ${CYAN}VM Names:${NC} $VM_1, $VM_2"
echo -e "${GREEN}╚════════════════════════════════════════════╝${NC}"
echo ""
...
echo -e "${GREEN}======================================================================${NC}"
echo -e "${MAGENTA}   🎉 LAB COMPLETED SUCCESSFULLY! ALL TASKS EXECUTED PERFECTLY. 🎉   ${NC}"
echo -e "${GREEN}======================================================================${NC}"
