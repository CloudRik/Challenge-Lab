...
print_welcome() {
    clear
    echo "${BOLD}====================================================${RESET}"
    echo "${BOLD}        IMASIS | Google Cloud Terraform Lab         ${RESET}"
    echo "${BOLD}                    GSP345                            ${RESET}"
    echo "${BOLD}====================================================${RESET}"
    echo
    echo "${CYAN}${BOLD}                 Script by IMASIS${RESET}"
    echo
}
...
print_completion() {
    ...
    echo "${BOLD}====================================================${RESET}"
    echo
    echo "${GREEN}${BOLD}All Terraform tasks have been completed.${RESET}"
    echo "${CYAN}${BOLD}Script by IMASIS${RESET}"
    echo
}
...
echo "${BOLD}Starting Lab Execution${RESET}"
