...
```bash
curl -LO "https://raw.githubusercontent.com/CloudrIK/Challenge-Lab/refs/heads/main/Build-Infrastructure-with-Terraform-on-Google-Cloud-Challenge-Lab/script.sh"
