...
```bash
curl -fsSL 'https://raw.githubusercontent.com/CloudRik/Challenge-Lab/main/Store-Process-and-Manage-Data-on-Google-Cloud-Challenge-Lab/arc102-automation.sh' | bash
